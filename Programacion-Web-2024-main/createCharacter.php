    ...
    <div class="create-character-container">
        ...
        <form method="POST">
            ...
            <select id="race" name="race">
                <option value="Saiyan">Hechicero</option>
                <option value="Namek">Maldicion</option>
                <option value="Humano">Humano</option>
                <option value="Freezer Race">Shikigamis</option>
                <option value="Majin">Maldiciones Especiales</option>
            </select>
